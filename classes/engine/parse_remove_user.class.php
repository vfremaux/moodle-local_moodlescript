...
class parse_remove_user extends tokenizer {

    public static $samples;

    public function __construct() {
        self::$samples = "REMOVE USER idnumber:<useridnumber>\n";
        self::$samples .= "REMOVE USER id:<userid>\n";
        self::$samples .= "REMOVE USER email:<email>\n";
        self::$samples .= "REMOVE USER username:<username>\n";
    }
    ...
    public function parse() {
        $this->trace('...Start parse remove user '.$this->remainder);
